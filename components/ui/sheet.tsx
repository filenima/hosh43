...
...props
 ...
 side === "top" &&
 "data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top inset-x-0 top-0 max-h-[85dvh] overflow-y-auto border-b",
 side === "bottom" &&
 "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom inset-x-0 bottom-0 max-h-[85dvh] overflow-y-auto border-t rounded-t-xl",
 className
 )}
 {...props}
 >
